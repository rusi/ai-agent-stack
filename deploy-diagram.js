...
(function () {
  ...
  function agentBox(x, y, num) {
    ...
    return [
      ...
      '  <text x="' + cx + '" y="' + (y + 36) + '" text-anchor="middle" font-size="30" font-weight="800" fill="var(--text-primary)" opacity="' + baseOp + '">Agent ' + num + '</text>',
      '  <rect x="' + secX + '" y="' + (y + 50) + '" width="' + secW + '" height="50" rx="14" fill="var(--amber-bg)" stroke="var(--amber)" stroke-width="1.5" opacity="' + baseOp + '"/>',
      '  <text x="' + cx + '" y="' + (y + 82) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--amber)" opacity="' + baseOp + '">Context</text>',
      '  <rect x="' + secX + '" y="' + (y + 110) + '" width="' + secW + '" height="50" rx="14" fill="var(--green-bg)" stroke="var(--green)" stroke-width="1.5" opacity="' + baseOp + '"/>',
      '  <text x="' + cx + '" y="' + (y + 142) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--green)" opacity="' + baseOp + '">Engine</text>',
      '  <rect x="' + secX + '" y="' + (y + 170) + '" width="' + secW + '" height="50" rx="14" fill="var(--card-bg)" stroke="var(--orange)" stroke-width="1.5" opacity="' + baseOp + '"/>',
      '  <text x="' + cx + '" y="' + (y + 202) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--orange)" opacity="' + baseOp + '">Tools / Bash</text>',
    ].join('\n');
  }
  ...
  function modelBox(x, y, w, h, name, provider) {
    ...
    return [
      ...
      '  <text x="' + cx + '" y="' + (y + 30) + '" text-anchor="middle" font-size="16" font-weight="600" fill="var(--text-muted)" opacity="' + baseOp + '">' + provider + '</text>',
      '  <text x="' + cx + '" y="' + (y + 68) + '" text-anchor="middle" font-size="30" font-weight="800" fill="var(--blue)" opacity="' + baseOp + '">' + name + '</text>',
    ].join('\n');
  }
  ...
  function pillLabel(cx, y, text, color, pw) {
    ...
    return [
      ...
      '  <text x="' + cx + '" y="' + (y + 6) + '" text-anchor="middle" font-size="16" font-weight="800" letter-spacing="2" fill="white">' + text + '</text>',
    ].join('\n');
  }
  ...
  function warnIcon(x, y, num) {
    return [
      ...
      '  <text x="' + x + '" y="' + (y + 1) + '" text-anchor="middle" font-size="13" font-weight="800" fill="white" dominant-baseline="middle">' + num + '</text>',
    ].join('\n');
  }
  ...
  container.innerHTML = [
    ...
    '  <text x="' + (fsx + fsw/2) + '" y="' + (fsy + 28) + '" text-anchor="middle" font-size="16" font-weight="800" letter-spacing="2" fill="var(--coral)" opacity="' + baseOp + '">LOCAL FILESYSTEM</text>',
    ...
    '  <text x="' + (mlx + mlw/2) + '" y="' + (mly + 28) + '" text-anchor="middle" font-size="16" font-weight="800" letter-spacing="2" fill="var(--purple)" opacity="' + baseOp + '">LOCAL MCP</text>',
    ...
    '  <text x="' + (rcx + rcw/2) + '" y="' + (rmcy + 34) + '" text-anchor="middle" font-size="16" font-weight="800" letter-spacing="2" fill="var(--rose)" opacity="' + baseOp + '">REMOTE MCP</text>',
    '  <text x="' + (rcx + rcw/2) + '" y="' + (rmcy + 78) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--text-primary)" opacity="' + baseOp + '">GitHub</text>',
    '  <text x="' + (rcx + rcw/2) + '" y="' + (rmcy + 118) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--text-primary)" opacity="' + baseOp + '">Jira</text>',
    '  <text x="' + (rcx + rcw/2) + '" y="' + (rmcy + 158) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--text-primary)" opacity="' + baseOp + '">Slack</text>',
    '  <text x="' + (rcx + rcw/2) + '" y="' + (rmcy + 198) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--text-primary)" opacity="' + baseOp + '">Notion</text>',
    '  <text x="' + (rcx + rcw/2) + '" y="' + (rmcy + 238) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--text-primary)" opacity="' + baseOp + '">Linear</text>',
    ...
    '  <text x="' + (rcx + rcw/2) + '" y="' + (ssy + 28) + '" text-anchor="middle" font-size="16" font-weight="800" letter-spacing="2" fill="var(--coral)" opacity="' + baseOp + '">SAAS / EXTERNAL APIS</text>',
    '  <text x="' + (rcx + 65) + '" y="' + (ssy + 62) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--text-primary)" opacity="' + baseOp + '">Google</text>',
    '  <text x="' + (rcx + 185) + '" y="' + (ssy + 62) + '" text-anchor="middle" font-size="22" font-weight="700" fill="var(--text-primary)" opacity="' + baseOp + '">Stripe</text>',

    // Model row — background group + ALL on same Y
    '  <rect x="' + (lm1x - 16) + '" y="' + (modY - 30) + '" width="' + (cm2x + cm2w - lm1x + 32) + '" height="' + (mh + 50) + '" rx="24" fill="var(--card-bg)" stroke="var(--border-color)" stroke-width="2" opacity="' + baseOp + '"/>',
    '  <text x="' + ((lm2x + lm2w + cm1x) / 2) + '" y="' + (modY - 10) + '" text-anchor="middle" font-size="16" font-weight="800" letter-spacing="2" fill="var(--blue)" opacity="' + baseOp + '">MODELS</text>',
    modelBox(lm1x, modY, lm1w, mh, 'Llama', 'Private / Local'),
    ...
    '  <text x="' + ((mlx + mlw + rcx) / 2) + '" y="' + (arrowY - 12) + '" text-anchor="middle" font-size="16" font-weight="700" fill="var(--coral)">external API calls</text>',
    '</g>',
    ...
    '  <text x="' + ((a1x + a3x + aw) / 2) + '" y="-18" text-anchor="middle" font-size="30" font-weight="800" fill="var(--teal)">Orchestrator</text>',
    ...
    '  <text x="' + (a1x + aw/2 - 10) + '" y="' + ((20 + ay) / 2) + '" text-anchor="end" font-size="16" fill="var(--teal)" font-weight="700">task</text>',
    '  <text x="' + (a2x + aw/2 - 10) + '" y="' + ((20 + ay) / 2) + '" text-anchor="end" font-size="16" fill="var(--teal)" font-weight="700">task</text>',
    '  <text x="' + (a3x + aw/2 - 10) + '" y="' + ((20 + ay) / 2) + '" text-anchor="end" font-size="16" fill="var(--teal)" font-weight="700">task</text>',
    '</g>',
    ...
    '  <text x="' + (a1x + aw/2 + 10) + '" y="' + ((20 + ay) / 2) + '" font-size="16" fill="var(--teal)" font-weight="700">result</text>',
    '  <text x="' + (a2x + aw/2 + 10) + '" y="' + ((20 + ay) / 2) + '" font-size="16" fill="var(--blue)" font-weight="700">review</text>',
    '  <text x="' + (a3x + aw/2 + 10) + '" y="' + ((20 + ay) / 2) + '" font-size="16" fill="var(--orange)" font-weight="700">report</text>',
    '</g>',

    '<text x="1040" y="700" text-anchor="end" font-size="13" fill="var(--text-light)" opacity="0.35" font-family="DM Sans,sans-serif">' + SITE_VERSION + '</text>',
    '</svg>'
  ].join('\n');
})();
